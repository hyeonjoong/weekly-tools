...
echo "        --json ideas.json --dropout 0.2 --effect-scale 0.7 --n-tests 5"
echo "        --repeats 3 --icc 0.3 --one-sided --max-n 300 --feasible-only"
echo "        --templates 내팩.json]"
echo " 임상 종점(반응률·생존)도 사이징: --templates examples/clinical_pack.json"
echo "------------------------------------------------------------------"
