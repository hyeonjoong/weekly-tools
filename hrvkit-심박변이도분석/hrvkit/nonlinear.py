...
DFA는 Peng et al. (1995) 정의를 그대로 따릅니다: 평균 제거 후 누적적분한
프로파일을 크기 n의 겹치지 않는 구간으로 나눠 각 구간에서 최소제곱 선형추세를
제거하고, 잔차의 제곱평균제곱근 F(n)을 구합니다. log F(n) ~ log n 의 기울기가
스케일링 지수 α입니다. α1(단기, 기본 4–16박동), α2(장기, 기본 16–64박동).
